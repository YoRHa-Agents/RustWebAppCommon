...
- `StoryDetail`：承接 runtime、desktop preview、release contract、docs front door、remote review seam 等细节主题
...
- remote review 只展示 `local SSH config -> remote host -> readonly review summary` 语义，不演示 remote write 或 sync
